...
test '1 0 0 1 0' 'int mymain() {long a=0x7fffffffffffffff,b=0xffffffffffffffff;printf("%d %d ",a>=0,b>0);a++;b++;printf("%d %d ",a>=0,b==0);return 0;}'
test '1 1 1 1 0' 'int mymain() {unsigned long a=0x7fffffffffffffff,b=0xffffffffffffffff;printf("%d %d ",a>=0,b>0);a++;b++;printf("%d %d ",a>=0,b==0);return 0;}'
test '1 0 0 1 0' 'int mymain() {long long a=0x7fffffffffffffff,b=0xffffffffffffffff;printf("%d %d ",a>=0,b>0);a++;b++;printf("%d %d ",a>=0,b==0);return 0;}'
test '1 1 1 1 0' 'int mymain() {unsigned long long a=0x7fffffffffffffff,b=0xffffffffffffffff;printf("%d %d ",a>=0,b>0);a++;b++;printf("%d %d ",a>=0,b==0);return 0;}'
